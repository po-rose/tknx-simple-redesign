      ...
      <div className="container mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="feature-card">
            ...
            <h3 className="text-xl font-semibold mb-3">Post-Quantum Security</h3>
            <p className="text-gray-400">
              Protected against quantum computing attacks with advanced cryptographic algorithms.
            </p>
          </div>
          
          <div className="feature-card">
            <div className="feature-icon">
              <Database className="h-6 w-6 text-tknx-blue" />
            </div>
            <h3 className="text-xl font-semibold mb-3">API Financial Core Engine</h3>
            <p className="text-gray-400">
              Programmatic connectivity to legacy finance systems for seamless integration.
            </p>
          </div>
          
          <div className="feature-card">
            <div className="feature-icon">
              <Network className="h-6 w-6 text-tknx-blue" />
            </div>
            <h3 className="text-xl font-semibold mb-3">High Scalability</h3>
            <p className="text-gray-400">
              Efficient scaling with next-generation consensus mechanisms and structure.
            </p>
          </div>
          
          <div className="feature-card">
            <div className="feature-icon">
              <Scale className="h-6 w-6 text-tknx-blue" />
            </div>
            <h3 className="text-xl font-semibold mb-3">Interoperability</h3>
            <p className="text-gray-400">
              Connect with other platforms through cross-chain bridges and open standards.
            </p>
          </div>
          
          <div className="feature-card">
            <div className="feature-icon">
              <Lock className="h-6 w-6 text-tknx-blue" />
            </div>
            <h3 className="text-xl font-semibold mb-3">Proof-of-Authority Governance</h3>
            <p className="text-gray-400">
              Regulatory-compliant consensus mechanism with verified authority nodes.
            </p>
          </div>
          
          <div className="feature-card">
            <div className="feature-icon">
              <Code className="h-6 w-6 text-tknx-blue" />
            </div>
            <h3 className="text-xl font-semibold mb-3">Smart Contracts</h3>
            <p className="text-gray-400">
              Advanced programmable contracts with financial instrument templates.
            </p>
          </div>
        </div>
